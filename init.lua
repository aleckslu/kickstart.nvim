...
-- [[ Primeagen keymaps ]] -- remaps

-- -- [[ Prevent deleting from replacing current yank ]]
--

vim.keymap.set({ 'n', 'v' }, '<leader>d', [["_d]])
vim.keymap.set('x', '<leader>P', [["_dP]], { desc = '[p]aste w/o Register Change' })
...
-- keeps the cursor from jumping around
...
vim.keymap.set('n', '<leader>bd', '<cmd>bprev<bar>bd #<cr>', { desc = 'Delete Buffer' })
  ...
  require('lazy').setup({
    ...
    { -- LSP Configuration & Plugins
      ...
      dependencies = {
        ...
        -- latex language server for gramar/spell checking
        -- 'valentjn/ltex-ls',
      },
      config = function()
